...
int main() // main function of the program
{
    ...
    printf("%c\n", symbol2); // print the symbol and go to a new line
    printf("%c\n", symbol3); // print the symbol and go to a new line

    printf("names: \n");
    printf("%s\n", name1); // print the string
    printf("%s\n", name2); // print the string
    printf("%s\n", name3); // print the string
    ...
    printf("%.15lf\n", precise2); // print the double with 15 decimal places
    printf("%.15lf\n", precise3); // print the double with 15 decimal places

    printf("booleans: \n");
    printf("%d\n", in_school);  // print the boolean as an integer
    printf("%d\n", employed);   // print the boolean as an integer
    printf("%d\n", in_college); // print the boolean as an integer
